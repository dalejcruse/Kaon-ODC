...
this;b._a.on("keydown.rskb",function(e){!b._g2&&!b._h2&&(37===e.keyCode?(e.preventDefault(),b.prev()):39===e.keyCode&&(e.preventDefault(),b.next()))})},goTo:function(b,e){b!==this.currSlideId&&this._i2(b,this.st.transitionSpeed,!0,!e)},destroy:function(b){var e=this;e.ev.trigger("rsBeforeDestroy");e._a.off("keydown.rskb "+e._g1+" "+e._h1);e._b1.on(e._f1,function(b){e._b2(b)});e.slider.data("royalSlider","");b&&e.slider.remove()},_j2:function(b,e){function c(c,e,f){c.isAdded?(g(e,c),a(e,c)):(f||(f=
d.slidesJQ[e]),c.holder?f=c.holder:(f=d.slidesJQ[e]=k(f),c.holder=f),c.appendOnLoaded=!1,a(e,c,f),g(e,c),d._l2(c,f,b),appended=c.isAdded=!0)}function g(a,c){c.contentAdded||(d.setItemHtml(c,b),b||(c.contentAdded=!0))}function a(a,b,c){d._j&&(c||(c=d.slidesJQ[a]),c.css(d._g,(a+d._z+r)*d._s))}function f(a){if(j){if(a>m-1)return f(a-m);if(0>a)return f(m+a)}return a}var d=this,i,h,j=d._v,m=d.numSlides;if(!isNaN(e))return f(e);var l=d.currSlideId,r,n=b?Math.abs(d._k2-d.currSlideId)>=d.numSlides-1?0:1:
d._u,p=Math.min(2,n),s=!1,t=!1,q;for(h=l;h<l+1+p;h++)if(q=f(h),(i=d.slides[q])&&(!i.isAdded||!i.positionSet)){s=!0;break}for(h=l-1;h>l-1-p;h--)if(q=f(h),(i=d.slides[q])&&(!i.isAdded||!i.positionSet)){t=!0;break}if(s)for(h=l;h<l+n+1;h++)q=f(h),r=Math.floor((d._q-(l-h))/d.numSlides)*d.numSlides,(i=d.slides[q])&&c(i,q);if(t)for(h=l-1;h>l-1-n;h--)q=f(h),r=Math.floor((d._q-(l-h))/m)*m,(i=d.slides[q])&&c(i,q);if(!b){p=f(l-n);l=f(l+n);n=p>l?0:p;for(h=0;h<m;h++)if(!(p>l&&h>p-1)&&(h<n||h>l))if((i=d.slides[h])&&
i.holder)i.holder.detach(),i.isAdded=!1}},setItemHtml:function(b,e){function c(){a.isWaiting=!0;b.holder.html(g._c1.clone());a.slideId=-99}var g=this,a=b.holder,f=function(a){var b=a.sizeType;return function(d){var f=a.content,h=a.holder;if(d){var i=d.currentTarget;k(i).off("load error");if("error"===d.type){a.isLoaded=!0;a.image="";a.isLoading=!1;f.addClass("rsSlideError");h.html(f);a.holder.trigger("rsAfterContentSet");g.ev.trigger("rsAfterContentSet",a);return}}if(a.image){if(a.bigImage&&a.sizeType!==
b){"med"===b?a.isMedLoading=!1:"big"===b?a.isBigLoading=!1:a.isMedLoading=a.isLoading=!1;return}if(a.isLoaded){if(!a.isRendered&&e){c();return}g._m2(a)}else{var j;f.hasClass("rsImg")?(j=!0,d=f):(j=!1,d=f.find(".rsImg"));d.length&&d.is("a")&&(j?f=k('<img class="rsImg" src="'+a.image+'" />'):f.find(".rsImg").replaceWith('<img class="rsImg" src="'+a.image+'" />'),a.content=f);a.iW=i.width;0<a.iW&&(a.iH=i.height,a.isLoaded=!0,a.isLoading=!1,g._m2(a))}}else{if(!g._t&&e&&!a.isRendered){a.isRendered=!0;
c();return}a.isLoaded=!0;a.isLoading=!1}i=a.id-g._l;!e&&!a.appendOnLoaded&&g.st.fadeinLoadedSlide&&(0===i||(g._h2||g._g2)&&(-1===i||1===i))?(f.css(g._e+"transition","opacity 400ms ease-in-out").css({visibility:"visible",opacity:0}),h.html(f),setTimeout(function(){f.css("opacity",1)},6)):h.html(f);a.isRendered=!0;h.find("a").off("click.rs").on("click.rs",function(){if(g.dragSuccess)return!1;g._c2=!0;setTimeout(function(){g._c2=!1},3)});a.holder.trigger("rsAfterContentSet");g.ev.trigger("rsAfterContentSet",
a);a.appendOnLoaded&&g._l2(a,f,e)}};if(b.isLoaded)f(b)();else if(e)c();else if(b.image)if(b.isLoading){var d=1,i=function(){if(b.isLoading)if(b.isLoaded)f(b)();else{if(0===d%50){var a=b.imageLoader;if(a.complete&&void 0!==a.naturalWidth&&0!==a.naturalWidth&&0!==a.naturalHeight){f(b)();return}}300<d||(setTimeout(i,400),d++)}};i(b.sizeType)}else{var h=k("<img/>"),j=b.image;e?c():b.isLoading||(j||(j=h.attr("src"),h=k("<img/>")),b.holder.html(g._c1.clone()),b.isLoading=!0,b.imageLoader=h,h.one("load error",
f(b)).attr("src",j))}else f(b)()},_l2:function(b,e,c){var g=b.holder,a=b.id-this._l;this._j&&!c&&this.st.fadeinLoadedSlide&&(0===a||(this._h2||this._g2)&&(-1===a||1===a))?(e=b.content,e.css(this._e+"transition","opacity 400ms ease-in-out").css({visibility:"visible",opacity:0}),this._b1.append(g),setTimeout(function(){e.css("opacity",1)},6)):this._b1.append(g);b.appendOnLoaded=!1},_b2:function(b,e){var c=this,g;c.dragSuccess=!1;if(k(b.target).closest(".rsNoDrag",c._d1).length)return!0;e||c._h2&&c._n2();
if(c._g2)c.hasTouch&&(c._o2=!0);else{c.hasTouch&&(c._o2=!1);c._p2();if(c.hasTouch){var a=b.originalEvent.touches;if(a&&0<a.length)g=a[0],1<a.length&&(c._o2=!0);else return}else g=b,b.preventDefault();c._g2=!0;c._a.on(c._g1,function(a){c._q2(a,e)}).on(c._h1,function(a){c._r2(a,e)});c._s2="";c._t2=!1;c._u2=g.pageX;c._v2=g.pageY;c._w2=c._r=(!e?c._f:c._x2)?g.pageX:g.pageY;c._y2=0;c._z2=0;c._a3=!e?c._m:c._b3;c._c3=(new Date).getTime();if(c.hasTouch)c._a1.on(c._i1,function(a){c._r2(a,e)})}},_d3:function(b,
e){if(this._e3){var c=this._f3,g=b.pageX-this._u2,a=b.pageY-this._v2,f=this._a3+g,d=this._a3+a,i=!e?this._f:this._x2,f=i?f:d,h=this._s2;this._t2=!0;this._u2=b.pageX;this._v2=b.pageY;d=i?this._u2:this._v2;"x"===h&&0!==g?this._y2=0<g?1:-1:"y"===h&&0!==a&&(this._z2=0<a?1:-1);g=i?g:a;e?f>this._g3?f=this._a3+g*this._j1:f<this._h3&&(f=this._a3+g*this._j1):this._v||(0>=this.currSlideId&&0<d-this._w2&&(f=this._a3+g*this._j1),this.currSlideId>=this.numSlides-1&&0>d-this._w2&&(f=this._a3+g*this._j1));this._a3=
f;200<c-this._c3&&(this._c3=c,this._r=d);e?this._j3(this._a3):this._j&&this._i3(this._a3)}},_q2:function(b,e){var c=this;if(c.hasTouch){if(c._k3)return;var g=b.originalEvent.touches;if(g){if(1<g.length)return;point=g[0]}else return}else point=b;c._t2||(c._c&&(!e?c._b1:c._l3).css(c._e+c._o1,"0s"),function d(){c._g2&&(c._m3=requestAnimationFrame(d),c._n3&&c._d3(c._n3,e))}());if(c._e3)b.preventDefault(),c._f3=(new Date).getTime(),c._n3=point;else{var g=!e?c._f:c._x2,a=Math.abs(point.pageX-c._u2)-Math.abs(point.pageY-
c._v2)-(g?-7:7);if(7<a){if(g)b.preventDefault(),c._s2="x";else if(c.hasTouch){c._o3();return}c._e3=!0}else if(-7>a){if(g){if(c.hasTouch){c._o3();return}}else b.preventDefault(),c._s2="y";c._e3=!0}}},_o3:function(){this._k3=!0;this._t2=this._g2=!1;this._r2()},_r2:function(b,e){function c(a){return 100>a?100:500<a?500:a}function g(b,d){if(a._j||e)i=(-a._q-a._z)*a._s,h=Math.abs(a._m-i),a._b=h/d,b&&(a._b+=250),a._b=c(a._b),a._q3(i,!1)}var a=this,f,d,i,h;a.ev.trigger("rsDragRelease");a._n3=null;a._g2=
!1;a._k3=!1;a._e3=!1;a._f3=0;cancelAnimationFrame(a._m3);a._t2&&(e?a._j3(a._a3):a._j&&a._i3(a._a3));a._a.off(a._g1).off(a._h1);a.hasTouch&&a._a1.off(a._i1);a._m1();if(!a._t2&&!a._o2&&e&&a._p3){var j=k(b.target).closest(".rsNavItem");j.length&&a.goTo(j.index())}else if(d=!e?a._f:a._x2,a._t2&&!("y"===a._s2&&d||"x"===a._s2&&!d)){a.dragSuccess=!0;a._s2="";var m=a.st.minSlideOffset;f=a.hasTouch?b.originalEvent.changedTouches[0]:b;var l=d?f.pageX:f.pageY,r=a._w2;f=a._r;var n=a.currSlideId,p=a.numSlides,
s=d?a._y2:a._z2,t=a._v;Math.abs(l-r);f=l-f;d=(new Date).getTime()-a._c3;d=Math.abs(f)/d;if(0===s||1>=p)g(!0,d);else{if(!t&&!e)if(0>=n){if(0<s){g(!0,d);return}}else if(n>=p-1&&0>s){g(!0,d);return}if(e){i=a._b3;if(i>a._g3)i=a._g3;else if(i<a._h3)i=a._h3;else{m=d*d/0.006;j=-a._b3;l=a._r3-a._s3+a._b3;0<f&&m>j?(j+=a._s3/(15/(0.003*(m/d))),d=d*j/m,m=j):0>f&&m>l&&(l+=a._s3/(15/(0.003*(m/d))),d=d*l/m,m=l);j=Math.max(Math.round(d/0.003),50);i+=m*(0>f?-1:1);if(i>a._g3){a._t3(i,j,!0,a._g3,200);return}if(i<a._h3){a._t3(i,
j,!0,a._h3,200);return}}a._t3(i,j,!0)}else r+m<l?0>s?g(!1,d):a._i2("prev",c(Math.abs(a._m-(-a._q-a._z+1)*a._s)/d),!1,!0,!0):r-m>l?0<s?g(!1,d):a._i2("next",c(Math.abs(a._m-(-a._q-a._z-1)*a._s)/d),!1,!0,!0):g(!1,d)}}},_i3:function(b){b=this._m=b;this._c?this._b1.css(this._r1,this._s1+(this._f?b+this._t1+0:0+this._t1+b)+this._u1):this._b1.css(this._f?this._r1:this._q1,b)},updateSliderSize:function(b){var e,c;this.st.beforeResize&&this.st.beforeResize.call(this);if(this.st.autoScaleSlider){var g=this.st.autoScaleSliderWidth,
a=this.st.autoScaleSliderHeight;this.st.autoScaleHeight?(e=this.slider.width(),e!=this.width&&(this.slider.css("height",e*(a/g)),e=this.slider.width()),c=this.slider.height()):(c=this.slider.height(),c!=this.height&&(this.slider.css("width",c*(g/a)),c=this.slider.height()),e=this.slider.width())}else e=this.slider.width(),c=this.slider.height();this._e2=this.slider.offset();this._e2=this._e2[this._g];if(b||e!=this.width||c!=this.height){this.width=e;this.height=c;this._u3=e;this._v3=c;this.ev.trigger("rsBeforeSizeSet");
this._a1.css({width:this._u3,height:this._v3});this._s=(this._f?this._u3:this._v3)+this.st.slidesSpacing;this._w3=this.st.imageScalePadding;for(e=0;e<this.slides.length;e++)b=this.slides[e],b.positionSet=!1,b&&(b.image&&b.isLoaded)&&(b.isRendered=!1,this._m2(b));if(this._x3)for(e=0;e<this._x3.length;e++)b=this._x3[e],b.holder.css(this._g,(b.id+this._z)*this._s);this._j2();this._j&&(this._c&&this._b1.css(this._e+"transition-duration","0s"),this._i3((-this._q-this._z)*this._s));this.ev.trigger("rsOnUpdateNav");
this.st.afterResize&&this.st.afterResize.call(this)}},setSlidesOrientation:function(){},appendSlide:function(b,e){var c=this._o(b);if(isNaN(e)||e>this.numSlides)e=this.numSlides;this.slides.splice(e,0,c);this.slidesJQ.splice(e,0,'<div style="'+(this._j?"position: absolute;":"z-index: 0; display:none; opacity: 0; position: absolute;  left: 0; top: 0;")+'" class="rsSlide"></div>');e<this.currSlideId&&this.currSlideId++;this.ev.trigger("rsOnAppendSlide",[c,e]);this._z3(e);e===this.currSlideId&&this.ev.trigger("rsAfterSlideChange")},
removeSlide:function(b){var e=this.slides[b];e&&(e.holder&&e.holder.remove(),b<this.currSlideId&&this.currSlideId++,this.slides.splice(b,1),this.slidesJQ.splice(b,1),this.ev.trigger("rsOnRemoveSlide",[b]),this._z3(b),b===this.currSlideId&&this.ev.trigger("rsAfterSlideChange"))},_z3:function(){var b=this,e=b.numSlides,e=0>=b._q?0:Math.floor(b._q/e);b.numSlides=b.slides.length;0===b.numSlides?(b.currSlideId=b._z=b._q=0,b.currSlide=b._a4=null):b._q=e*b.numSlides+b.currSlideId;for(e=0;e<b.numSlides;e++)b.slides[e].id=
e;b.currSlide=b.slides[b.currSlideId];b._d1=b.slidesJQ[b.currSlideId];b.currSlideId>=b.numSlides?b.goTo(b.numSlides-1):0>b.currSlideId&&b.goTo(0);b._p();b._j&&b._v&&b._b1.css(b._e+b._o1,"0ms");b._b4&&clearTimeout(b._b4);b._b4=setTimeout(function(){b._i3((-b._q-b._z)*b._s);b._j2()},14);b.ev.trigger("rsOnUpdateNav")},_m1:function(){!this.hasTouch&&this._j&&(this._k1?this._a1.css("cursor",this._k1):(this._a1.removeClass("grabbing-cursor"),this._a1.addClass("grab-cursor")))},_p2:function(){!this.hasTouch&&
this._j&&(this._l1?this._a1.css("cursor",this._l1):(this._a1.removeClass("grab-cursor"),this._a1.addClass("grabbing-cursor")))},next:function(b){this._i2("next",this.st.transitionSpeed,!0,!b)},prev:function(b){this._i2("prev",this.st.transitionSpeed,!0,!b)},_i2:function(b,e,c,g,a){var f=this,d,i,h;f._d4&&f.stopVideo();f.ev.trigger("rsBeforeMove",[b,g]);newItemId="next"===b?f.currSlideId+1:"prev"===b?f.currSlideId-1:b=parseInt(b,10);if(!f._v){if(0>newItemId){f._e4("left",!g);return}if(newItemId>=f.numSlides){f._e4("right",
!g);return}}f._h2&&(f._n2(),c=!1);i=newItemId-f.currSlideId;h=f._k2=f.currSlideId;var j=f.currSlideId+i,g=f._q,m;f._v?(j=f._j2(!1,j),g+=i):g=j;f._l=j;f._a4=f.slidesJQ[f.currSlideId];f._q=g;f.currSlideId=f._l;f.currSlide=f.slides[f.currSlideId];f._d1=f.slidesJQ[f.currSlideId];j=Boolean(0<i);i=Math.abs(i);var l=Math.floor(h/f._u),k=Math.floor((h+(j?2:-2))/f._u),l=(j?Math.max(l,k):Math.min(l,k))*f._u+(j?f._u-1:0);l>f.numSlides-1?l=f.numSlides-1:0>l&&(l=0);h=j?l-h:h-l;h>f._u&&(h=f._u);if(i>h+2){f._z+=
(i-(h+2))*(j?-1:1);e*=1.4;for(h=0;h<f.numSlides;h++)f.slides[h].positionSet=!1}f._b=e;f._j2(!0);a||(m=!0);d=(-g-f._z)*f._s;m?setTimeout(function(){f._c4=!1;f._q3(d,b,!1,c);f.ev.trigger("rsOnUpdateNav")},0):(f._q3(d,b,!1,c),f.ev.trigger("rsOnUpdateNav"))},_z1:function(){this.st.arrowsNav&&(1>=this.numSlides?(this._w1.css("display","none"),this._x1.css("display","none")):(this._w1.css("display","block"),this._x1.css("display","block"),!this._v&&!this.st.loopRewind&&(0===this.currSlideId?this._w1.addClass("rsArrowDisabled"):
this._w1.removeClass("rsArrowDisabled"),this.currSlideId===this.numSlides-1?this._x1.addClass("rsArrowDisabled"):this._x1.removeClass("rsArrowDisabled"))))},_q3:function(b,e,c,g,a){function f(){var a=i.data("rsTimeout");a&&(i!==h&&i.css({opacity:0,display:"none",zIndex:0}),clearTimeout(a),i.data("rsTimeout",""));if(a=h.data("rsTimeout"))clearTimeout(a),h.data("rsTimeout","")}var d=this,i,h,j={};isNaN(d._b)&&(d._b=400);d._m=d._a3=b;d.ev.trigger("rsBeforeAnimStart");d.st.beforeSlideChange&&d.st.beforeSlideChange.call(d);
d._c?d._j?(j[d._e+d._o1]=d._b+"ms",j[d._e+d._p1]=g?k.rsCSS3Easing[d.st.easeInOut]:k.rsCSS3Easing[d.st.easeOut],d._b1.css(j),setTimeout(function(){d._i3(b)},d.hasTouch?5:0)):(d._b=d.st.transitionSpeed,i=d._a4,h=d._d1,h.data("rsTimeout")&&h.css("opacity",0),f(),i&&i.data("rsTimeout",setTimeout(function(){j[d._e+d._o1]="0ms";j.zIndex=0;j.display="none";i.data("rsTimeout","");i.css(j);setTimeout(function(){i.css("opacity",0)},16)},d._b+60)),j.display="block",j.zIndex=d._k,j.opacity=0,j[d._e+d._o1]="0ms",
j[d._e+d._p1]=k.rsCSS3Easing[d.st.easeInOut],h.css(j),h.data("rsTimeout",setTimeout(function(){h.css(d._e+d._o1,d._b+"ms");h.data("rsTimeout",setTimeout(function(){h.css("opacity",1);h.data("rsTimeout","")},20))},20))):d._j?(j[d._f?d._r1:d._q1]=b+"px",d._b1.animate(j,d._b,g?d.st.easeInOut:d.st.easeOut)):(i=d._a4,h=d._d1,h.stop(!0,!0).css({opacity:0,display:"block",zIndex:d._k}),d._b=d.st.transitionSpeed,h.animate({opacity:1},d._b,d.st.easeInOut),f(),i&&i.data("rsTimeout",setTimeout(function(){i.stop(!0,
!0).css({opacity:0,display:"none",zIndex:0})},d._b+60)));d._h2=!0;d.loadingTimeout&&clearTimeout(d.loadingTimeout);d.loadingTimeout=a?setTimeout(function(){d.loadingTimeout=null;a.call()},d._b+60):setTimeout(function(){d.loadingTimeout=null;d._f4(e)},d._b+60)},_n2:function(){this._h2=!1;clearTimeout(this.loadingTimeout);if(this._j)if(this._c){var b=this._m,e=this._a3=this._g4();this._b1.css(this._e+this._o1,"0ms");b!==e&&this._i3(e)}else this._b1.stop(!0),this._m=parseInt(this._b1.css(this._r1),10);
else 20<this._k?this._k=10:this._k++},_g4:function(){var b=window.getComputedStyle(this._b1.get(0),null).getPropertyValue(this._e+"transform").replace(/^matrix\(/i,"").split(/, |\)$/g);return parseInt(b[this._f?4:5],10)},_h4:function(b,e){return this._c?this._s1+(e?b+this._t1+0:0+this._t1+b)+this._u1:b},_f4:function(){this._j||(this._d1.css("z-index",0),this._k=10);this._h2=!1;this.staticSlideId=this.currSlideId;this._j2();this._i4=!1;this.ev.trigger("rsAfterSlideChange");this.st.afterSlideChange&&
this.st.afterSlideChange.call(this)},_e4:function(b,e){var c=this,g=(-c._q-c._z)*c._s;moveDist=30;if(0!==c.numSlides)if(c.st.loopRewind)"left"===b?c.goTo(c.numSlides-1,e):c.goTo(0,e);else if(!c._h2&&c._j&&0!==moveDist){c._b=200;var a=function(){c._h2=!1};c._q3(g+("left"===b?moveDist:-moveDist),"",!1,!0,function(){c._h2=!1;c._q3(g,"",!1,!0,a)})}},_m2:function(b){if(!b.isRendered){var e=b.content,c="rsImg",g,a=this.st.imageAlignCenter,f=this.st.imageScaleMode,d;b.videoURL&&(c="rsVideoContainer","fill"!==
f?g=!0:(d=e,d.hasClass(c)||(d=d.find("."+c)),d.css({width:"100%",height:"100%"}),c="rsImg"));e.hasClass(c)||(e=e.find("."+c));var i=b.iW,c=b.iH;b.isRendered=!0;if("none"!==f||a){bMargin="fill"!==f?this._w3:0;b=this._u3-2*bMargin;d=this._v3-2*bMargin;var h,j,k={};if("fit-if-smaller"===f&&(i>b||c>d))f="fit";if("fill"===f||"fit"===f)h=b/i,j=d/c,h="fill"==f?h>j?h:j:"fit"==f?h<j?h:j:1,i=Math.ceil(i*h,10),c=Math.ceil(c*h,10);"none"!==f&&(k.width=i,k.height=c,g&&e.find(".rsImg").css({width:"100%",height:"100%"}));
a&&(k.marginLeft=Math.floor((b-i)/2)+bMargin,k.marginTop=Math.floor((d-c)/2)+bMargin);e.css(k)}}}};k.rsProto=u.prototype;k.fn.royalSlider=function(b){var e=arguments;return this.each(function(){var c=k(this);if("object"===typeof b||!b)c.data("royalSlider")||c.data("royalSlider",new u(c,b));else if((c=c.data("royalSlider"))&&c[b])return c[b].apply(c,Array.prototype.slice.call(e,1))})};k.fn.royalSlider.defaults={slidesSpacing:8,startSlideId:0,loop:!1,loopRewind:!1,numImagesToPreload:4,fadeinLoadedSlide:!0,
slidesOrientation:"horizontal",transitionType:"move",transitionSpeed:600,controlNavigation:"bullets",controlsInside:!0,arrowsNav:!0,arrowsNavAutoHide:!0,navigateByClick:!0,randomizeSlides:!1,sliderDrag:!0,sliderTouch:!0,keyboardNavEnabled:!1,fadeInAfterLoaded:!0,allowCSS3:!0,allowCSS3OnWebkit:!0,addActiveClass:!1,autoHeight:!1,easeOut:"easeOutSine",easeInOut:"easeInOutSine",minSlideOffset:10,imageScaleMode:"fit-if-smaller",imageAlignCenter:!0,imageScalePadding:4,autoScaleSlider:!1,autoScaleSliderWidth:800,
autoScaleSliderHeight:400,autoScaleHeight:!0,arrowsNavHideOnTouch:!1,globalCaption:!1,beforeSlideChange:null,afterSlideChange:null,beforeResize:null,afterResize:null};k.rsCSS3Easing={easeOutSine:"cubic-bezier(0.390, 0.575, 0.565, 1.000)",easeInOutSine:"cubic-bezier(0.445, 0.050, 0.550, 0.950)"};k.extend(jQuery.easing,{easeInOutSine:function(b,e,c,g,a){return-g/2*(Math.cos(Math.PI*e/a)-1)+c},easeOutSine:function(b,e,c,g,a){return g*Math.sin(e/a*(Math.PI/2))+c},easeOutCubic:function(b,e,c,g,a){return g*
((e=e/a-1)*e*e+1)+c}})})(jQuery,window);
